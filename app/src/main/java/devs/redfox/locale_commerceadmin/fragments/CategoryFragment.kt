...
import devs.redfox.locale_commerceadmin.adapter.CategoryAdapter
import devs.redfox.locale_commerceadmin.databinding.FragmentCategoryBinding
...
class CategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.apply {
            ...
            btnAddCategoryImage.setOnClickListener {
    ...
    private fun getData() {
        ...
        Firebase.firestore.collection("categories")
            .get().addOnSuccessListener {
                ...
                binding.rvCategoryItems.adapter = CategoryAdapter(requireContext(), list)
            }
    }
    ...
    private fun storeData(categoryName: String, url: String) {
        ...
        db.collection("categories").add(data)
            .addOnSuccessListener {
                dialog.dismiss()
                binding.categoryImageView.setImageDrawable(resources.getDrawable(R.drawable.imagepreview))
